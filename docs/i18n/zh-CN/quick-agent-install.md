...
1. 从 <https://github.com/whshang/herdr-mcp/releases> 下载 `herdr-mcp` — 使用最新 stable 版本（当前快照为 [`v0.4.2`](https://github.com/whshang/herdr-mcp/releases/tag/v0.4.2)，后续始终优先更新的 stable tag）
