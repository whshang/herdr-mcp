...
Second-machine maintainer validation lives in [Clean-machine UAT](clean-machine-uat.md) and [Second Mac Agent prompt](second-mac-agent-prompt.md). Do not give end users the 34-step UAT prompt.
