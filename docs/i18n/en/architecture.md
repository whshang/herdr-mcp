...
- [extension-wake.md](./extension-wake.md) — track A: workspace observation + global manual/per-Project mode + Project automation switch + progress/settled push-back + manual actions + timeout recovery / safe Project rollover
