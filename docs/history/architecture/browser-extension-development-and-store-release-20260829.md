...
> Historical snapshot: this document preserves the pre-1.0 Store rollout and extension-development record through the original August/early-September candidate series. Version numbers, Store-candidate claims, branch state, and remaining-task lists below are provenance, not current release guidance. Current work lives in [`docs/_wip/browser-extension-development-and-store-release.md`](../../_wip/browser-extension-development-and-store-release.md).
>
> 原状态：WIP / 开发期文档
>
