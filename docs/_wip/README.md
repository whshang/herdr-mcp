...
Current active WIP is limited to unresolved work: browser control-plane settlement, DEV/STANDALONE/STORE extension distribution, modular progressive skills, and the cross-cutting performance/resource plan.
...
- Active performance/resource plan: [`v1.0-performance-resource-plan.md`](v1.0-performance-resource-plan.md).
