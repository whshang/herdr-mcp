...
export const NAV_GROUPS = [
  { slugs: ["overview", "design-philosophy", "quick-start", "install", "quick-agent-install", "clean-machine-uat", "second-mac-agent-prompt", "chatgpt-connector"] },
