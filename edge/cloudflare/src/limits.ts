...
/** Temporary generic R2 artifact relay. Objects never ride the 1 MiB MCP/DO frame. */
...
export const ARTIFACT_IMAGE_MIME_TYPES = Object.freeze(["image/png", "image/jpeg", "image/gif", "image/webp"]);
