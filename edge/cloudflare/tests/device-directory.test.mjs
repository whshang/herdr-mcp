...
test("device directory joins durable identity with read-only WorkstationDO state", async () => {
  ...
  const statuses = new Map([
    ["prod-real-runtime", { online: true, connected: true, runtimeHealth: "healthy", runtimeVersion: "0.4.2", runtimeGeneration: "rust-a", lastSeenAgoMs: 12, lastRecoveredAtMs: 5_000, lastReconnectDurationMs: 220, reconnectCount: 2, lastReconnectCrossedRecycleThreshold: false, activeRequests: 2 }],
